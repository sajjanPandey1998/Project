...
protected void edit(KeyEvent ke){
		 ...
		 while(tokenizer.hasMoreTokens()){
			 ...
			 fout.close();
				 ...
				 ta.append("Error: can't saave program"+token+"\n");
			 }
			 }
				 ...
				 if(!commandEnter.equals("")){
					 ...
					 /////////////////////////////////CHANGE DIRECTORY///////////////////////////////////////////////////////////
						 ...
						 try{
							 ...
							 if(cd.exists()==false)ta.append("Error:File does't exist \n");
              ...
              /////////////////////////////////////////////////////////////////LOCAL DATE /////////////////////////////////////////////
   		             else if(commandEnter.startsWith("local")||commandEnter.startsWith("local"))
					 {
						...
						try{
							...
							ta.append("Usage: local -kr(Korea)\n");
					 ...
					 ///////////////////////OS INFORMATION /////////////////////////////////
						 ...
						 ta.append("OS Architecture:"+os_arch+"type\n");
						  ...
						  if(os_name.equals("Window 95")) ta.append("(Windows 98/ME)\n");
						   ta.append("OS Version:"+os_version+"\n");
						    ta.append("OS Registered :"+usr_Name+"\n");
						...
						else if(commandEnter.startsWith("prompt")||commandEnter.startsWith("prompt"))
						{
							...
							ta.setEditable(false);
							   ...
							   else
							   {
								   ...
								   }catch(Exception e){ta.append("Error: Illelgal command call \n\n");}
								   ta.append(currentPath+prompt);
								   ta.setEditable(false);
								   tf.requestFocus();
							   }
